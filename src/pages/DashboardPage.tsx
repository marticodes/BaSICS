  ...
  return (
    <section className="space-y-4">
      ...
      <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-5">
        ...
        <Stat label="Categories" value={new Set(tools.map((tool) => tool.category)).size} />
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <ChartCard title="Tools per category"><CategoryBar data={categoryData as { category: string; value: number }[]} /></ChartCard>
